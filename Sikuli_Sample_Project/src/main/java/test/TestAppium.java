...
public class TestAppium {
	...
	public void room1TestCase() throws InterruptedException, FindFailed, IOException {
		...
		sc.wait("D:/Wanka project/New Images/Room1/Room1_refrence.png", waitTime);
	...
	public void room2TestCase() throws InterruptedException, FindFailed, IOException {
		...
		// Room2 Entry
		sc.wait("D:/Wanka project/New Images/Room2/room2_refernce.png", waitTime);
		Location room2RegionLoc = sc.find("D:/Wanka project/New Images/Room2/room2_refernce").getCenter();
	...
	public void room3TestCase() throws InterruptedException, FindFailed, IOException {
		...
		Region room3Region = sc.newRegion(room3RegionLoc, 600, 600);
	...
	private boolean exists(String image, Screen sc) throws FindFailed {
			...
			if (sc.wait(image, 6).find(image) != null) {
				return true;
			} else
				return false;
